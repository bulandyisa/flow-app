#!/bin/bash
# Бот 3 — Аккаунт 2, основная сессия (.session_2/)
# Использование:
#   ./scripts/run_bot3.sh --review --clip S05_A
#   ./scripts/run_bot3.sh --generate-refs
#   FLOW_TIMEOUT=900 ./scripts/run_bot3.sh --review
#   Первый запуск: ./scripts/run_bot3.sh --login
...
BOT_NUM=3
SESSION_DIR="$PROJECT_DIR/.session_2"
